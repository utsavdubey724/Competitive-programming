...
Return the index of the word in sentence (1-indexed) where searchWord is a prefix of this word. If searchWord is a prefix of more than one word, return the index of the 
    ...
    def isPrefixOfWord(self, sentence: str, searchWord: str) -> int:
        ...
        for i in range(len(list1)):
            ...
            for j in range(len(searchWord)):
                if(len(current) < len(searchWord)):
                   flag = 0
                   break
                if(current[j] != searchWord[j]):
                    flag = 0
                    break
            if(flag):
                return i + 1
